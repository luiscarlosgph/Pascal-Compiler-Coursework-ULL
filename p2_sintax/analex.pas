...
interface
   ...
   type
      Token = (ANDX, ARRAYX, ASTERISKX, BECOMESX, BEGINX, COLONX, COMMAX, CONSTX, 
      DIVX, DOX, DOUBLEDOTX, ELSEX, ENDX, ENDTEXTX, EQUALX, GREATERX, IDX, IFX, 
      LEFTBRACKETX, LEFTPARENTHESISX, LESSX, MINUSX, MODX, NOTX, NOTEQUALX, 
      NOTGREATERX, NOTLESSX, NUMERALX, OFX, ORX, PERIODX, PLUSX, PROCEDUREX, 
      PROGRAMX, RECORDX, RIGHTBRACKETX, RIGHTPARENTHESISX, SEMICOLONX, THENX, 
      TYPEX, TOKEN_ERRORX, VARX, WHILEX);
   ...
   var
      ...
      TOKEN_STR : array[1..43] of string[16] = ('AND', 'ARRAY', 'ASTERISK', 'BECOMES', 
                                             'BEGIN', 'COLON', 'COMMA', 'CONST', 
                                             'DIV', 'DO', 'DOUBLEDOT', 'ELSE', 'END',
                                             'ENDTEXT', 'EQUAL', 'GREATER', 'ID', 
                                             'IF', 'LEFTBRACKET', 'LEFTPARENTHESIS',
                                             'LESS', 'MINUS', 'MOD', 'NOT', 
                                             'NOTEQUAL', 'NOTGREATER', 'NOTLESS', 
                                             'NUMERAL', 'OF', 'OR', 'PERIOD', 'PLUS',
      ...
      case c of
         ...
         begin
            ...
            begin
               ...
               if(ec <> 0) then
                  writeln('   (EE) Error, entero no valido en la linea ', line_num, 
                          ' y columna ', col_num, '.');
            end
